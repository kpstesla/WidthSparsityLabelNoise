...
python main.py --config exps/caltech_r18.yaml --mislabel_ratio 0.4 --subset --subset_size 0.5 --width 256 --run_name "ct256_r18_n60_s050_w256" --gpu 4
...
python main.py --config exps/caltech_r18.yaml --mislabel_ratio 0.4 --subset --subset_size 1.0 --width 256 --run_name "ct256_r18_n60_s100_w256" --gpu 4